...
<div align="center">
  ...
  🌐 Creating responsive **Web** solutions with **React.js**, **HTML5**, **CSS3**, **JavaScript**
  
  ☁️ Leveraging **Firebase** & **Cloudinary** for scalable cloud solutions
  
  💡 Currently exploring **Node.js**, **TypeScript** & **Backend Architecture**
  
  🎨 **UI/UX** enthusiast focused on clean, intuitive & accessible design
  
  📚 **Continuous learner** | Open source contributor | Tech explorer
